 ...
 * The User class represents the individual that is currently logged into the application.
 * They can either be a normal employee, or a manager. Managers are created internally by the DB Administrator, and cannot actually
